...
console.log(team1Goalkeeper, team1fieldPlayers);
...
function printGoals(...playersName) {
	console.log(...playersName, `Total goals scored ${playersName.length}`);
}
...
const whoWon =
	(team1 > team2 && `${game.team2} Won!`) ||
	(team1 < team2 && `${game.team1} Won!`);
console.log(whoWon);
