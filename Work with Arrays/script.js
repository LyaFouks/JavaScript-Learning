...
// const withdrawalsOver300Num1 = accounts
// 	.flatMap((account) => account.transactions)
// 	.reduce((counter, trans) => (trans <= -300 ? counter + 1 : counter), 0);
// console.log(withdrawalsOver300Num1);
...
// // Ex. 4
// // work with arrays in javascript -> Work with Arrays in Javascript

// const text1 = "work with arrays in javascript";
// const text2 =
// 	"work with arrays in javascript with simple language for beginners";
// const text3 = "work with arrays and strings in javascript";
// const text4 = "for what need arrays in javascript?";

// const textTotTitleCase = function (text) {
// 	const exeptions = ["with", "in", "and", "for", "a", "an", "at", "on"];
...
// console.log(textTotTitleCase(text1));
// console.log(textTotTitleCase(text2));
// console.log(textTotTitleCase(text3));
// console.log(textTotTitleCase(text4));

//////////////////////////////////////////////////////////////////////////

// // OTHER WAYS TO CREATE AND POPULATE ARRAYS (fill() and Array.from() Methods)
